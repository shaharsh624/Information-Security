...
def generate_playfair_matrix(key):
    ...
    for j in range(0, len(matrix), 5):
        playfair_matrix[i] = matrix[j : j + 5]
        i += 1
...
cipher = playfair_encrypt(plain_text, keyword)
print("Cipher Text:", cipher)
print("Plain Text:", playfair_decrypt(cipher, keyword))
